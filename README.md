...
The compiled VST3 or CLAP plugin can be loaded into a DAW like any other metering plugin. It's recommended that you use a buffer size of 256 and avoid sample rates below 44100Hz.
